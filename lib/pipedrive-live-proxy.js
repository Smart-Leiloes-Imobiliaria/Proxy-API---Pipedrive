...
// valor bruto o id da opcao; o label e resolvido via getDealFieldMaps_ (cacheado).
...
async function getLeanDealForTriagem_(dealId) {
  ...
  return getCached_(cacheKey, DEFAULT_CONFIG.detailCacheTtlSeconds, async () => {
    ...
    const byKey = (fieldMaps && fieldMaps.byKey) ? fieldMaps.byKey : {};
    ...
    return {
      ...
      status_financiamento: resolveOptionLabel_(cf[TRIAGEM_FIELD_KEYS.status_financiamento], byKey[TRIAGEM_FIELD_KEYS.status_financiamento]),
      status_fgts_financiado: resolveOptionLabel_(cf[TRIAGEM_FIELD_KEYS.status_fgts_financiado], byKey[TRIAGEM_FIELD_KEYS.status_fgts_financiado]),
