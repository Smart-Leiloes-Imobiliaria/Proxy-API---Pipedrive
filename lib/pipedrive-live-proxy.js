...
function buildFilterDealPayload_(deal, lookups) {
  ...
  return compactObject_({
    ...
    campos: compactObject_({
      ...
      "Valor: Total da Proposta": formatMonetary_(pickField(FILTER_21468_FIELD_KEYS.valor_total_proposta)),
      "Valor médio estimado de venda": formatMonetary_(pickField(FILTER_21468_FIELD_KEYS.valor_medio_estimado_venda)),
      "Valor avaliação Caixa": formatMonetary_(pickField(FILTER_21468_FIELD_KEYS.valor_avaliacao_caixa))
    })
  });
}
